...
time_interval = 5000*5      # The amount of time to consider. the sampliong frequency is 5kHz
all_channels_seizure = all_channels_seizure[:, :time_interval]

num_time_differences = 3    # The number of time between peak differences to compute
