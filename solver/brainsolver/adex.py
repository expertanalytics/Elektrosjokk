...
class AdExManual(CardiacCellModel):
    ...
    def I(self, V, w, time=None):
        ...
        V = conditional(lt(V, 30), V, 0)    # TODO: parameter rathern than 30
        # Define current
    ...
    def F(self, V, w, time=None):
        ...
        w = conditional(lt(V, 30), w, w + b)    # TODO: parameter rather than 30
        # Define model
