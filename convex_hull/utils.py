...
def make_pymesh(points, simplices=None):
    ...
    simplices : array_like, optional
        Indices of points forming 2D simplices on the surface of the mesh. If `simplices` is None,
        triangulate the points using scipy.spatial.ConvexHull (default in None).
    ...
    if simplices is None:
        surf_tri = scipy.spatial.ConvexHull(points) # use ConvexHull surface triangulation
