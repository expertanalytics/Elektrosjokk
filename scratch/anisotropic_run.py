...
def get_solver(*, brain: Model, Ks: float, Ku: float) -> MultiCellSplittingSolver:
    ...
    splitting_parameters = xalbrain.SplittingSolver.default_parameters()
    # splitting_parameters["BidomainSolver"]["linear_solver_type"] = "iterative"
    ...
    # splitting_parameters["BidomainSolver"]["Chi"] = 1.26e3
    # splitting_parameters["BidomainSolver"]["Cm"] = 1.0
    splitting_parameters["pde_solver"] = "monodomain"
    # splitting_parameters["MonodomainSolver"]["Chi"] = 1.26e3
    # splitting_parameters["MonodomainSolver"]["Cm"] = 1.0
    splitting_parameters["MonodomainSolver"]["algorithm"] = "gmres"
    splitting_parameters["MonodomainSolver"]["preconditioner"] = "petsc_amg"
    splitting_parameters["MonodomainSolver"]["linear_solver_type"] = "iterative"

    solver = xalbrain.SplittingSolver(brain, parameters=splitting_parameters)
